...
function displayDate(dates) {
  const formattedDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(dates.current, "EEEE, MMM do y");
...
function main(){
 (0,_fetchData__WEBPACK_IMPORTED_MODULE_0__["default"])("Baltimore").then(_displayData__WEBPACK_IMPORTED_MODULE_1__["default"]);
